    ...
    return (
        <div className="container max-w-4xl py-12 animate-fade-in flex flex-col items-center">
            <div className="mb-12 text-center max-w-2xl px-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 text-[11px] font-black mb-4 uppercase tracking-widest">
                    <UploadCloud className="h-3 w-3" />
                    New Lecture
                </div>
                <h1 className="text-4xl font-extrabold tracking-tight mb-4 bg-clip-text text-transparent bg-gradient-to-r from-zinc-900 to-zinc-500 dark:from-white dark:to-zinc-500">
                    Process Your Lecture
                </h1>
                <p className="text-zinc-500 text-lg">
                    Transform your class recordings and YouTube videos into structured academic notes, quizzes, and summaries instantly.
                </p>
            </div>

            <div className="w-full max-w-2xl px-4 space-y-8">
                <div className="grid gap-6 md:grid-cols-2 p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl shadow-sm">
                    <div className="grid gap-2">
                        <Label htmlFor="course" className="text-xs font-bold uppercase tracking-wider text-zinc-400">Course Name</Label>
                        <Input
                            id="course"
                            placeholder="e.g., ECON 101"
                            value={courseName}
                            onChange={(e) => setCourseName(e.target.value)}
                            className="h-11 rounded-xl border-zinc-200 focus:border-indigo-500 focus:ring-indigo-500 transition-all"
                        />
                    </div>
                    <div className="grid gap-2">
                        <Label htmlFor="professor" className="text-xs font-bold uppercase tracking-wider text-zinc-400">Professor</Label>
                        <Input
                            id="professor"
